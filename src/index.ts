  ...
  execute: async (args, { log }) => {
    try {
      ...
      if (args.section === 'all') {
        ...
        const sectionConfig = config[args.section as keyof typeof config];
        return {
          content: [{
            type: "text", 
  ...
  execute: async (args, { log }) => {
    try {
      ...
      if (typeof sectionConfig === 'object' && sectionConfig !== null && sectionConfig !== undefined) {
        ...
        Object.assign(sectionConfig as unknown as Record<string, unknown>, args.updates);
        ...
        const globalSectionConfig = CONFIG[args.section as keyof typeof CONFIG];
        if (typeof globalSectionConfig === 'object' && globalSectionConfig !== null && globalSectionConfig !== undefined) {
          Object.assign(globalSectionConfig as unknown as Record<string, unknown>, args.updates);
        }
...
server.addTool({
  ...
  execute: async (args, { log }) => {
    try {
      ...
      const configToValidate = args.testConfig ? args.testConfig as any : CONFIG;
